...
# !!! Main.UserApp is configured as an alias for Main.MySoccer and you might encounter it in some tests
using Main.MySoccer, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MySoccer tests" begin
  @includetests ARGS
end
